							...
							<div class="card_body">
								<mm_form class="bar_filter">
									...
									<mm_list :col="3">
										...
										<mm_item>
											<control_select v-model="query.user_id" title="审批人" :options="$to_kv(list_account, 'user_id', 'nickname')"
											 @change="search()" />
										</mm_item>
										<mm_item>
								...
								<mm_table type="2">
									<thead class="table-sm">
										<tr>
											...
											<th>
												<control_reverse title="提现状态" v-model="query.orderby" field="state" :func="search"></control_reverse>
											</th>
											<th>
											...
											<th>
												<control_reverse title="审批人" v-model="query.orderby" field="user_id" :func="search"></control_reverse>
											</th>
											<th>
												<control_reverse title="提现金额" v-model="query.orderby" field="amount" :func="search"></control_reverse>
											</th>
											<th>
											...
											<th>
												<control_reverse title="转账支付时间" v-model="query.orderby" field="pay_time" :func="search"></control_reverse>
											</th>
											<th>
												<control_reverse title="资金到账时间" v-model="query.orderby" field="time_end" :func="search"></control_reverse>
											</th>
											<th>
											...
											<th>
												<control_reverse title="收款方式" v-model="query.orderby" field="way" :func="search"></control_reverse>
											</th>
											<th>
												<control_reverse title="转账机构" v-model="query.orderby" field="institution" :func="search"></control_reverse>
											</th>
											<th>
												<control_reverse title="发起提现时的IP" v-model="query.orderby" field="ip" :func="search"></control_reverse>
											</th>
											<th>
											...
											<th>
												<control_reverse title="拒绝原因" v-model="query.orderby" field="cause" :func="search"></control_reverse>
											</th>
											<th>
												<control_reverse title="商户备注" v-model="query.orderby" field="note" :func="search"></control_reverse>
											</th>
	...
	export default {
		...
		data() {
			return {
				...
				url_import: "/apis/pay/account_discount?method=import&",
				url_export: "/apis/pay/account_discount?method=export&",
				field: "discount_id",
				query_set: {
					"discount_id": ""
				},
