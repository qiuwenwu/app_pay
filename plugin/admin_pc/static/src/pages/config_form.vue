							...
							<div class="card_body">
								<mm_form>
									<dl>
										...
										<dd>
											<control_input v-model="form.type" :minlength="0" :maxlength="16" placeholder="string文本型 / number数字型 / boolean布尔型"
											 :required="true" />
										</dd>
										<dt>变量标题</dt>
										<dd>
...
<script>
	...
	export default {
		...
		data() {
			return {
				url_add: "/apis/pay/config?method=add",
				url_set: "/apis/pay/config?method=set",
				url_get_obj: "/apis/pay/config?method=get_obj",
				field: "config_id",
				query: {
					"config_id": 0
				},
